...
public class ActiveCampaignConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        ...
        init("activecampaign-connector-1.0.2-SNAPSHOT");
        ...
        String subject = System.currentTimeMillis() + connectorProperties.getProperty("subject");
        String emailMandatory = System.currentTimeMillis() + connectorProperties.getProperty("emailMandatory");
        String emailOptional = System.currentTimeMillis() + connectorProperties.getProperty("emailOptional");
        connectorProperties.setProperty("subject", subject);
        connectorProperties.setProperty("emailMandatory", emailMandatory);
        connectorProperties.setProperty("emailOptional", emailOptional);
    ...
    @Test(priority = 1, groups = { "wso2.esb" },
            description = "activecampaign {createMailingList} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateMailingListWithMandatoryParameters" },
            description = "activecampaign {createMailingList} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateMailingListWithOptionalParameters" },
            description = "activecampaign {createMailingList} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateMailingListWithNegativeCase" },
            description = "activecampaign {listMailingLists} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListMailingListsWithMandatoryParameters" },
            description = "activecampaign {listMailingLists} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListMailingListsWithOptionalParameters" },
            description = "activecampaign {listMailingLists} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListMailingListsWithNegativeCase" },
            description = "activecampaign {createContact} integration test with mandatory parameters.")
    ...
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateContactWithMandatoryParameters" },
            description = "activecampaign {createContact} integration test with optional parameters.")
    ...
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateContactWithOptionalParameters" },
            description = "activecampaign {createContact} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateContactWithNegativeCase" },
            description = "activecampaign {getContactByEmail} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetContactByEmailWithMandatoryParameters" },
            description = "activecampaign {getContactByEmail} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetContactByEmailWithNegativeCase" },
            description = "activecampaign {createMessage} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateMessageWithMandatoryParameters" },
            description = "activecampaign {createMessage} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateMessageWithNegativeCase" },
            description = "activecampaign {getMessageById} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetMessageByIdWithMandatoryParameters" },
            description = "activecampaign {getMessageById} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetMessageByIdWithNegativeCase" },
            description = "activecampaign {listMessages} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListMessagesWithOptionalParameters" },
            description = "activecampaign {listMessages} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListMessagesWithNegativeCase" },
            description = "activecampaign {createCampaign} integration test with mandatory parameters.")
    ...
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateCampaignWithMandatoryParameters" },
            description = "activecampaign {createCampaign} integration test with optional parameters.")
    ...
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateCampaignWithOptionalParameters" },
            description = "activecampaign {createCampaign} integration test negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateCampaignNegativeCase" },
            description = "activecampaign {getCampaignClickers} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetCampaignClickersWithMandatoryParameters" },
            description = "activecampaign {getCampaignClickers} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetCampaignClickersWithNegativeCase" },
            description = "activecampaign {listCampaigns} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListCampaignsWithMandatoryParameters" },
            description = "activecampaign {listCampaigns} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListCampaignsWithOptionalParameters" },
            description = "activecampaign {listCampaigns} integration test with negative case.")
    ...
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateContactWithOptionalParameters" },
            description = "activecampaign {listContacts} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListContactsWithMandatoryParameters" },
            description = "activecampaign {listContacts} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListContactsWithOptionalParameters" },
            description = "activecampaign {listContacts} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateContactWithMandatoryParameters" },
            description = "activecampaign {updateContact} integration test with mandatory parameters.")
    ...
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testUpdateContactWithMandatoryParameters" },
            description = "activecampaign {updateContact} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testUpdateContactWithOptionalParameters" },
            description = "activecampaign {updateContact} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testUpdateContactWithNegativeCase" },
            description = "activecampaign {createDeal} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateDealWithMandatoryParameters" },
            description = "activecampaign {createDeal} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateDealWithOptionalParameters" },
            description = "activecampaign {createDeal} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateDealWithNegativeCase" },
            description = "activecampaign {getDeal} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetDealWithMandatoryParameters" },
            description = "activecampaign {getDeal} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetDealWithNegativeCase" },
            description = "activecampaign {listDeals} integration test with mandatory parameters.")
    public void testListDealsWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("deals").getJSONObject(0).getString("id"),
                apiRestResponse.getBody().getJSONArray("deals").getJSONObject(0).getString("id"));
        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("deals").getJSONObject(0).getString("title"),
                apiRestResponse.getBody().getJSONArray("deals").getJSONObject(0).getString("title"));
        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("deals").getJSONObject(0).getString("value"),
                apiRestResponse.getBody().getJSONArray("deals").getJSONObject(0).getString("value"));
        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("deals").getJSONObject(0).getString("contact_email"),
                apiRestResponse.getBody().getJSONArray("deals").getJSONObject(0).getString("contact_email"));
        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("deals").getJSONObject(0).getString("created"),
                apiRestResponse.getBody().getJSONArray("deals").getJSONObject(0).getString("created"));
    }

    /**
     * Positive test case for listDeals method with optional parameters.
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListDealsWithMandatoryParameters" },
            description = "activecampaign {listDeals} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListDealsWithOptionalParameters" },
            description = "activecampaign {listDeals} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListDealsWithNegativeCase" },
            description = "activecampaign {updateDeal} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testUpdateDealWithOptionalParameters" },
            description = "activecampaign {updateDeal} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testUpdateDealWithNegativeCase" },
            description = "activecampaign {createDealStage} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateDealStageWithMandatoryParameters" },
            description = "activecampaign {createDealStage} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateDealStageWithOptionalParameters" },
            description = "activecampaign {createDealStage} integration test with negative case.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateDealStageWithNegativeCase" },
            description = "activecampaign {listDealStages} integration test with optional parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testListDealStagesWithOptionalParameters" },
            description = "activecampaign {listDealStages} integration test with negative case.")
